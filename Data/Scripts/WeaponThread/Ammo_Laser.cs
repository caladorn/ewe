...
{ // Don't edit above this line
    ...
    {
        private AmmoDef Laser => new AmmoDef
        {      
            AmmoMagazine = "Energy",
            AmmoRound = "Laser",
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 2500f, // Distance at which max damage begins falling off.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.0f, // controls how sharp the trajectile may turn
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    Ammo = new ParticleDef
                    {
                        Name = "", //ShipWelderArc
                        ShrinkByDistance = false,
                        Color = Color(red: 256, green: 56, blue: 98, alpha: 1),
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "WhiteSpark", // WhiteSpark, Spark3, Spark4, Smoke_lit, Explosion 
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 256, green: 8, blue: 16, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.1f,
                        Color = Color(red: 12, green: 2, blue: 3, alpha: 4),
                        
                        Textures = new[] 
                        {
                            "WeaponLaser", // WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                        },
