...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition LargeCruiseMissileLauncher => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                {
                    new MountPointDef {
                        SubtypeId = "LargeBlockCruiseMissileLauncher",
                        MuzzlePartId = "None",
            ...
            {
                WeaponName = "CruiseMissileLauncher", // name of weapon in terminal
                ...
                Loading = new LoadingDef
                {
                    ...
                    HeatSinkRate = 64, //amount of heat lost per second
