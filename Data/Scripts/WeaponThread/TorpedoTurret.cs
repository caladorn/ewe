...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition TorpedoTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                {
                    new MountPointDef {
                        SubtypeId = "LargeBlockTorpedoTurret",
                    ...
                    new MountPointDef {
                        SubtypeId = "SmallBlockTorpedoTurret",
                        MuzzlePartId = "MissileTurretBarrels",
                        AzimuthPartId = "MissileTurretBase1",
                        ElevationPartId = "MissileTurretBarrels",
                        DurabilityMod = 1f,
            ...
            {
                WeaponName = "TorpedoTurret", // name of weapon in terminal
                DeviateShotAngle = 5f,
