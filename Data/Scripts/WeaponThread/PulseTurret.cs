...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition PulseTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                ...
                {
                    new MountPointDef {
                        SubtypeId = "LargeBlockPlasmaTurret",
            ...
            {
                WeaponName = "PulseTurret", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    ...
                    MaxHeat = 27500, //max heat before weapon enters cooldown (70% of max heat)
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "SmallPlasmaTurretFire", // WepShipGatlingShot
